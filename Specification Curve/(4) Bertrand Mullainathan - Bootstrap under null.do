...
****************************
	...
	tempname scurve
	postfile `scurve' montek k1 k2 k3  eblack pblack einter pinter  using monte_lakisha, replace
	
	*Begin bootstrap loop
	forvalue montek=0(1)500 {
		
		*Shuffle race
		*After montek=0 start shuffling names
			if `montek'>0 {
				shufflevar black ,cluster(adid) dropold  //Suffle within ad
				rename black_shuffled black			  	 //Give the shuffled variables the same name
				}
...
*(3) Subsample
   ...
   *RUN `SPEC' AND SAVE RESULTS
	...
	*ASSES FIT
			...
			*save results
				post `scurve' (`montek') (`k1') (`k2') (`k3') (`eblack') ( `pblack') (`einter') (`pinter') 
