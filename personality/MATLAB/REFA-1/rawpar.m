...
percent   = 70  ; % Enter the desired percentile here
...
disp([(1:nvars).'  realeval means  percentiles]);
...
legend('real data eigenvalues','mean random eigenvalues','percentile random eigenvalues',1); legend boxoff; 
